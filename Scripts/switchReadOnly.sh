...
if [ "$1" == "ro" ]; then
    ...
    cp ../wso2-kubecluster-ha-mode/deployments/is_node_RO.yaml ../wso2-kubecluster-ha-mode/templates/is_deployment.yaml
    helm upgrade wso2-is-ha ../wso2-kubecluster-ha-mode
elif [ "$1" == "rw" ]; then
    rm -f ../wso2-kubecluster-ha-mode/templates/is_deployment.yaml
    cp ../wso2-kubecluster-ha-mode/deployments/is_node_RW.yaml ../wso2-kubecluster-ha-mode/templates/is_deployment.yaml
    helm upgrade wso2-is-ha ../wso2-kubecluster-ha-mode
else
